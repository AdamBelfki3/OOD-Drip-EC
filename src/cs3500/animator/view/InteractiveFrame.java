...
public class InteractiveFrame extends VisualFrame {
  ...
  protected JButton resume = new JButton("Resume");
  protected JButton fastForward = new JButton("x2");
  protected JButton fastBackward = new JButton("x0.5");
  protected JButton looper = new JButton("loop");
