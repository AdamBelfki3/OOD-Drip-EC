...
public class AnimationReader {
  ...
  private static <Doc> void readTempo(Scanner s, AnimationBuilder<Doc> builder) {
    ...
    String[] fieldNames = {"beginning interval", "ending interval"};
    for (int ii = 0; ii < 2; ii++) {
      tempInterval[ii] = getInt(s, "Tempo", fieldNames[ii]);
    }

    builder.addTempoInterval(tempInterval[0], tempInterval[1]);
